...
df1[["CommunicationTime", "ServerResponseTime", "TotalTime" ]] = df1[["CommunicationTime", "ServerResponseTime", "TotalTime" ]].apply(lambda x : x*1000)
...
p1.plot(df1['Time'], data2, pen="g") #Communication_time
p1.plot(df1['Time'], data3, pen="b") #Server Response
axis = DateAxisItem()
...
def mouseMoved(evt):
    ...
    if p1.sceneBoundingRect().contains(pos):
        ...
        label.setText(
            ...
            " <span style='color: green'>Communication response =%0.2f ms</span> ,"
            " <span style='color: blue'>Server response =%0.2f ms</span> "  % (
